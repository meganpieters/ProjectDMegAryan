  ...
  return (
    <View style={styles.login}>
      <View style={[styles.rectangleParent, styles.rectangleLayout]}>
        ...
        <Text style={[styles.login1, styles.loginTypo1]}>Login3</Text>
        <Text style={[styles.text, styles.textTypo1]}>|</Text>
        <Pressable style={[styles.login2, styles.loginTypo]} onPress={() => navigation.navigate("Home")}>
          <Text style={styles.loginTypo}>Login2</Text>
        </Pressable>
      ...
      <View style={[styles.rectangleGroup, styles.rectangleLayout]}>
        ...
        <Text style={[styles.login3, styles.loginTypo1]}>Login33</Text>
